...
The vending machine is a classical example, often used as a hello-world program for process algebras.
...
CSP does not distinguish between inputs and outputs, which is reflected by the choice after inserting a coin.
The machine can either output a small biscuit or take another coin as input.
...
When the user has input exactly 1 or 2 coins, a continue button becomes enabled.
