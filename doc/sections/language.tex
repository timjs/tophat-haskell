...
We will embed our task language,
the syntactic category $p$ of pretasks,
into this basic language.
It is further specified in \autoref{fig:task-grammar}.
Pretasks $p$ are tasks \emph{in making},
just as expressions are values in making.
\todo{Say something about embedding?}
\todo{Say we're going to discuss each pretask in the next subsections.}
...
The typing rule for valued editors can be found in \refrule{T-Fill}.
