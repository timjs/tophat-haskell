...
using examples. These construct are formalized in \cref{sec:semantics}.
...
Our Haskell implementation of \TOPHAT supports annotating tasks with user IDs, so that individual tasks in a large workflow can be assigned to different users.
