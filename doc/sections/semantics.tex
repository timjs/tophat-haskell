...
As with internal stepping, this is only possible if the lhs has a value and the continuation is not failing.
...
The step combinators pass all events other than $\Continue$ to the lhs.
