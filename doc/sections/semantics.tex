...
The three main layers of semantics are \emph{evaluation}, \emph{normalisation}, and \emph{interaction}.
...
% Coming from one to the other is done by the evaluation rules given in \cref{fig:evaluation-semantics}.
