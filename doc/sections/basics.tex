...
A task is a \emph{value with respect to the evaluation relation $\evaluate$}.
\todo{Add more info}
This means pretasks will be eagerly evaluated to tasks,
as \textcite[p. 323]{books/Harper16PFPL} suggests is the best way to do.
