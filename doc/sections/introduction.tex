...
In this paper, we set out to develop a formal basis for \TOP, called \TOPHAT.
...
With \TOPHAT it should be possible to express very complicated real-world situations,
