...
Handling actions is done by a new semantic relation.
This relation takes a task $t$ and an action $\alpha$ which results in a new task $t'$.
We write
\begin{equation*}
  \boxed{t \handle{\alpha} t'}
\end{equation*}
