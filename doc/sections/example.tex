...
For brevity, we ommit the type annotations of variable bindings.
...
\begin{figure}[h]
  ...
  \caption{
    ...
    The message bubble shows the user is only allowed to enter an integer in the \TS{age} field.
  }
