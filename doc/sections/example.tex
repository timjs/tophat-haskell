...
\begin{figure}[h]
  ...
  \caption{
    ...
    Note that the first user can not pick seats \smallcaps{1b} and \smallcaps{1c} any more.
    Also, the message bubble shows that only integer values are allowed in the \TS{age} field.
  }
