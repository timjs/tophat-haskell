...
A flight booking starts with the task of entering a valid list of passengers,
...
it would also be impossible to model the parallel execution of three \TS{bookFlight} tasks.
