...
\begin{grammar}
  ...
  Pretasks
    ...
    &      &\mid& \View e              & – valued readonly editor \\
...
\begin{grammar}
  ...
  Tasks
    ...
    &      &\mid& \View v              & – valued readonly editor \\
    &      &\mid& \Enter \beta         & – unvalued editor \\
...
\begin{mathpar}
  ...
  \userule{H-Update} \qquad \userule{H-Fail}
\end{mathpar}

\todo{
  Should $\Fail$ be a black hole or just go stuck?
  Probably it should go stuck, than $\Firsts(\Fail)$ is empty!
}
...
\todo{
  ...
  It is an input you can always send, so it fucks up $\Firsts$\ldots
