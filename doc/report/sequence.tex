...
\begin{align*}
    & \Fill \Int \Then \lambda n. \If{n \ge 10}{\Edit \str{large}}{\Fail} \\
  \drive{8} & \hint{change value to eight, lhs evaluates to $\Fail$} \\
    & \Edit 8 \Then \lambda n. \If{n \ge 10}{\Edit \str{large}}{\Fail} \\
  \drive{3} & \hint{change value to three, lhs still failing} \\
    & \Edit 3 \Then \lambda n. \If{n \ge 10}{\Edit \str{large}}{\Fail} \\
  \drive{12} & \hint{change value to twelve, lhs succeeds now!} \\
    & \Edit \str{large}
\end{align*}
