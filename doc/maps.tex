...
\newmacro{O-Inputs}{
  \begin{function}
    ...
    \Inputs(t_1 \Next e_2,s)       &=& \Inputs(t_1,s) \cup \phantom{}\\
                                   & & \set{\Continue \mid \Value(t_1, s) = v_1 \land e_2\ v_1, s \normalise t_2, s' \land \lnot\Failing(t_2, s')} \\
    ...
    \Inputs(e_1 \Xor e_2,s)        &=& \set{\Pick \phantom{\Right}\makebox[0pt][r]{$\Left$} \mid e_1, s \normalise t_1, s' \land \lnot\Failing(t_1, s')} \cup \phantom{} \\
