...
\newcommand*{\TCont}
  {\inferrule*[lab=T-Cont]
    {\Gamma\st{\Sigma} \infers t_1 : \Task \tau_1 \\
     \Gamma\st{\Sigma} \infers e : \tau_1 \to \Task \tau_2}
    {\Gamma\st{\Sigma} \infers t_1 \Cont e : \Task \tau_2}}
...
\newcommand*{\NContStay}
  {\inferrule*[lab=N-ContStay,right={$\Value(t_1) = \nothing$}]
    {\ }
    {t_1 \Cont e\st{s} \normalise t_1 \Cont e\st{s}}}

\newcommand*{\NContFail}
  {\inferrule*[lab=N-ContFail,right={$\Value(t_1) = v \land (t_2 = \Fail \lor t_2 = t_3 \Or t_4)$}]
    {e\ v \downto t_2}
    {t_1 \Cont e\st{s} \normalise t_1 \Cont e\st{s}}}

\newcommand*{\NContNext}
  {\inferrule*[lab=N-ContNext,right={$\Value(t_1) = v \land (t_2 \neq \Fail \lor t_2 \neq t_3 \Or t_4)$}]
    {e\ v \downto t_2    \\
     t_2\st{s} \normalise t_2'\st{s'} }
    {t_1 \Cont e\st{s} \normalise t_2' \Cont e\st{s'}}}
...
\newcommand*{\HStayS}
  {\inferrule*[lab=H-Stay',right={$\Value(t_1) = \nothing$}]
    {\ }
    {t_1 \Seq e\st{s} \handle{\Next} t_1 \Seq e\st{s}}}

\newcommand*{\HNextS}
  {\inferrule*[lab=H-Next',right={$\Value(t_1) = v$}]
    {e\ v \downto t_2    \\
     t_2\st{s} \normalise t_2'\st{s'} }
...
\newcommand*{\HStay}
  {\inferrule*[lab=H-Stay,right={$\Value(t_1) = \nothing$}]
    {\ }
    {t_1 \Cont e\st{s} \handle{\Execute \pi} t_1 \Cont e\st{s}}}

\newcommand*{\HFail}
  {\inferrule*[lab=H-Fail,right={$\Value(t_1) = v \land t_2 = \Fail$}]
    {e\ v \downto t_2    \\
     t_2\st{s} \handle{\Pick \pi} t_2'\st{s'} }
    {t_1 \Cont e\st{s} \handle{\Execute \pi} t_1 \Cont e\st{s}}}

\newcommand*{\HNext}
  {\inferrule*[lab=H-Next,right={$\Value(t_1) = v \land t_2 \neq \Fail$}]
    {e\ v \downto t_2    \\
     t_2\st{s} \handle{\Pick \pi} t_2'\st{s'} }
    {t_1 \Cont e\st{s} \handle{\Execute \pi} t_2' \Cont e\st{s'}}}
...
\newcommand*{\HPass}
  {\inferrule*[lab=H-Pass,right={$\eta \neq \Execute \pi$}]
    {t_1\st{s} \handle{\eta} t_1'\st{s'}}
    {t_1 \Cont e\st{s} \handle{\eta} t_1' \Cont e\st{s'}}}

\newcommand*{\HFirst}
  {\inferrule*[lab=H-First,right={$t_1 \neq \Fail$}]
    {\ }
    {t_1 \Or t_2\st{s} \handle{\Pick \First} t_1\st{s}}}

\newcommand*{\HSecond}
  {\inferrule*[lab=H-Second,right={$t_2 \neq \Fail$}]
    {\ }
    {t_1 \Or t_2\st{s} \handle{\Pick \Second} t_2\st{s}}}

\newcommand*{\HOther}
  {\inferrule*[lab=H-Other,right={$t_2 \neq \Fail$}]
    {t_2\st{s} \handle{\Pick \pi} t_2'\st{s'}}
